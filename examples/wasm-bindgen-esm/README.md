...
chunk (runtime: main) output.js (main) 3.03 KiB (javascript) 14.8 KiB (webassembly) 3.25 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
asset output.js 3.1 KiB [emitted] [minimized] (name: main)
chunk (runtime: main) output.js (main) 3.03 KiB (javascript) 14.8 KiB (webassembly) 2.98 KiB (runtime) [entry] [rendered]
  > ./example.js main

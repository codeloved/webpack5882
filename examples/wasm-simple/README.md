...
chunk (runtime: main) output.js (main) 1.27 KiB (javascript) 170 bytes (webassembly) 3.25 KiB (runtime) [entry] [rendered]
  > ./example.js main
...
```
asset output.js 2.58 KiB [emitted] [minimized] (name: main)
...
chunk (runtime: main) output.js (main) 1.27 KiB (javascript) 170 bytes (webassembly) 2.98 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 2.98 KiB 5 modules
  dependent modules 552 bytes (javascript) 170 bytes (webassembly) [dependent] 4 modules
  ./example.js 753 bytes [built] [code generated]
    [no exports]
    [no exports used]

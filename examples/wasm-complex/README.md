...
chunk (runtime: main) output.js (main) 696 bytes (javascript) 139 bytes (webassembly) 3.26 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 3.26 KiB 6 modules
...
chunk (runtime: main) output.js (main) 696 bytes (javascript) 139 bytes (webassembly) 2.99 KiB (runtime) [entry] [rendered]
  > ./example.js main
  runtime modules 2.99 KiB 5 modules
  dependent modules 449 bytes (javascript) 139 bytes (webassembly) [dependent] 4 modules
  ./example.js 247 bytes [built] [code generated]
    [no exports]
    [no exports used]
